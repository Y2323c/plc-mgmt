...
pg = st.navigation([
    ...
    st.Page("pages/09_アンケート配信.py",     title="工事中：出欠アンケート配信 — URL生成・送付",   icon="⚫"),
    st.Page("pages/08_アンケート.py",         title="工事中：出欠アンケート個別登録 — 事務局入力用", icon="⚫"),
    st.Page("pages/06_出席管理.py",           title="出席管理 — 状況確認、出欠状況の更新",          icon="⚫"),
    st.Page("pages/14_イベントCSV取込.py",    title="イベントCSV取込 — WS出欠インポート",           icon="⚫"),
